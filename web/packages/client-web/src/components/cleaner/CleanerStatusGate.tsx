...
interface CleanerStatusGateProps {
  children: ReactNode;
}

export default function CleanerStatusGate({ children }: CleanerStatusGateProps) {
  const navigate = useNavigate();
  const { pathname } = useLocation();
  const { data, loading } = useQuery(MY_CLEANER_PROFILE);
