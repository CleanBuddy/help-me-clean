...
('support_email', 'support@helpmeclean.ro', 'string', 'Email suport'),
('support_phone', '+40700000000', 'string', 'Telefon suport'),
('terms_url', 'https://helpmeclean.ro/termeni', 'string', 'URL termeni si conditii'),
('privacy_url', 'https://helpmeclean.ro/confidentialitate', 'string', 'URL politica confidentialitate'),
